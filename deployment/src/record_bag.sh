...
tmux send-keys "modprobe gs_usb" Enter
...
tmux send-keys "rosbag record /camera/left/image_raw/compressed /camera/right/image_raw/compressed /scout_status /cmd_vel -o $1" # change topic if necessary
