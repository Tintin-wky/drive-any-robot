...
tmux send-keys "rosbag record /rosout /camera/left/image_raw/compressed /camera/right/image_raw/compressed /scout_status /odom_chassis /robot_pose_ekf/odom_combined /gps/gps /imu -o gnm_classbot" Enter # change topic if necessary
